...
function About() {
  return (
    ...
    <div className='card container' style={{marginTop:"-6rem",width:"1000rem",height:"430px",fontSize:"20px"}}>
      ...
      <p>Movie masters dolor sit amet consectetur adipisicing elit. Odio, hic. Quae, explicabo voluptatibus accusantium sequi officia illum odio, similique repudiandae enim at facilis quod expedita ratione aperiam vero id placeat?</p><br />
      <p>This is a dolor sit, amet consectetur adipisicing elit. Praesentium porro molestiae consequuntur id perferendis debitis voluptatum, dolor aperiam, ipsa quod, repudiandae ab. Perferendis qui necessitatibus consectetur officiis non amet sit?</p>
